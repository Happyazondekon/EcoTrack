<header class="header">
    ...
    <div class="header-right">
        ...
        <!--                         <a href="#" class="clearfix"> -->
        <!--                             <figure class="image"> -->
        <!--                                 <img src="{{ assert('img/!sample-user.jpg') }}" alt="Joseph Junior" -->
        <!--                                     class="rounded-circle" /> -->
        <!--                             </figure> -->
        ...
        <!--                         <a href="#" class="clearfix"> -->
        <!--                             <figure class="image"> -->
        <!--                                 <img src="{{ asset('img/!sample-user.jpg') }}" alt="Joe Junior" -->
        <!--                                     class="rounded-circle" /> -->
        <!--                             </figure> -->
        ...
        <!--                         <a href="#" class="clearfix"> -->
        <!--                             <figure class="image"> -->
        <!--                                 <img src="{{ asset('img/!sample-user.jpg') }}" alt="Joseph Junior" -->
        <!--                                     class="rounded-circle" /> -->
        <!--                             </figure> -->
        <!--                             <span class="title">Joseph Junior</span> -->
        ...
        <div id="userbox" class="userbox">
            <a href="#" data-bs-toggle="dropdown">
                <figure class="profile-picture">
                    <img src="{{ Auth::user()->photo_profil ? asset('storage/' . Auth::user()->photo_profil) : asset('images/default-profile.png') }}"
                        alt="Joseph Doe" class="rounded-circle"
                        data-lock-picture="{{ asset('img/!logged-user.jpg') }}" />
                </figure>
                <div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
                    <span class="name">{{ Auth::user()->name . ' ' . Auth::user()->prenom ?? 'Guest' }}</span>
                    <span class="role">{{ Auth::user()->role->nom }}</span>
                </div>
                ...
                <ul class="list-unstyled mb-2">
                    ...
                    <li>
                        <a role="menuitem" tabindex="-1" href="{{ route('profile.edit') }}"><i
                                class="bx bx-user-circle"></i>Mon compte</a>
                    </li>
                    <!-- <li> -->
